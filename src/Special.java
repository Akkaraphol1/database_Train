...
public class Special extends JFrame{
	...
	public Special(String filename){
	    ...
	    getContentPane().add(send);
		  ...
		  ImageIcon image = new ImageIcon("C:/Users/User/workspace/TrainStation/img/STR.png");
	       JLabel imageLabel = new JLabel(image); 
	       imageLabel.setBounds(10, 10, 1880, 200);
	       imageLabel.setVisible(true);
	       getContentPane().add(imageLabel);	   
		   
	       ImageIcon image2 = new ImageIcon("C:/Users/User/workspace/TrainStation/img/TTG.png");
