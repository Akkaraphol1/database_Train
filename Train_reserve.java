...
public class Train_reserve extends JFrame {
	...
	public Train_reserve() {
		...
		CB[0].addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				int result = JOptionPane.showConfirmDialog(CB[0],
		...
		CB[1].addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				int result = JOptionPane.showConfirmDialog(CB[1],
		...
		CB[2].addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				int result = JOptionPane.showConfirmDialog(CB[2],
		...
		btnReset.setBounds(1200, 885, 109, 43);
		...
		// Table2
		Object[] colomns5 = { "First Name", "Last Name", "Start", "Destination", "Ticket Price", "Time out",
				"Arrival Time", "Train", "Seat NO.", "Status" };
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				if (RegisterTrain2()) {
					JOptionPane.showMessageDialog(null, "Congratulation!!! You have payment successfully.");
					row2[0] = T[0].getText();
					row2[1] = T[1].getText();
		...
		btnAdd.setBounds(1650, 885, 89, 43);
	...
	private Boolean RegisterTrain2() {
		...
		String Ban = T[3].getText();
		String Ban2 = CB[3].getText();

		if (strN.equals("")) // First Name
		{
			JOptionPane.showMessageDialog(null, "Please select one choice from Three" + "\nPlease Input (First Name)");
			T[0].requestFocus();
			return false;
		}
		...
		{
			JOptionPane.showMessageDialog(null, "Please to Choose Start and destiny");
			empid.requestFocusInWindow();
			return false;
		}
		if (Mon.equals("")) // Money
		{
			JOptionPane.showMessageDialog(null, "Please to Input(Money)");
			T[2].requestFocusInWindow();
			return false;
		}

		if (Ban.equals("")) // Balance
		{
			JOptionPane.showMessageDialog(null, "Please to press pay and choose ticket");
	...
	public static void main(String[] args) {
		Train_reserve TS3 = new Train_reserve();
